...
echo "\033[1;32m╔═══════════════════════════════════════════════════════════╗\n";
usleep(70000);
echo $dat.$vang."Tool Trao Đổi Sub Cookie Đa Luồng 2.0\n";
usleep(70000);
...
while (true){
if (file_exists("TKMK_TDS.txt")){
$data = fread(fopen("TKMK_TDS.txt", "r"), filesize("TKMK_TDS.txt"));
if ($data == "") { unlink("TKMK_TDS.txt"); continue; }
$_SESSION["username"] = explode("|",$data)[0];
$_SESSION['password'] = explode("|",$data)[1];
$login = login();
if ($login == false) { unlink("TKMK_TDS.txt"); continue; }
...
echo $daucau2."\033[1;92mDelay LikePost Hiện Tại Là \033[1;93m" . $json["delaylike"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Follow Hiện Tại Là \033[1;93m" . $json["delayfollow"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Comment Hiện Tại Là \033[1;93m" . $json["delaycmt"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Page Hiện Tại Là \033[1;93m" . $json["delaypage"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay SharePost Hiện Tại Là \033[1;93m" . $json["delayshare"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Cảm Xúc Hiện Tại Là \033[1;93m" . $json["delaycx"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Cảm Xúc Cmt Hiện Tại Là \033[1;93m" . $json["delaycxcmt"] . "\033[1;92m Giây\n";
echo $daucau2."\033[1;92mDelay Group Hiện Tại Là \033[1;93m" . $json["delaygr"] . "\033[1;92m Giây\n";
echo "\033[1;32m────────────────────────────────────────────────────────────\n";
echo $daucau2."\033[1;92mKích Hoạt Chống Block Sau \033[1;93m" . $json["nhiemvu"] . "\033[1;92m Nhiệm Vụ\n";
echo $daucau2."\033[1;92mDelay Chống Block Hiện Tại Là \033[1;93m" . $json["block"] . "\033[1;92m Giây\n";
echo "\033[1;32m────────────────────────────────────────────────────────────\n";
echo $daucau2."\033[1;92mNhập \033[1;91m[\033[1;93m1\033[1;91m] \033[1;92mTiếp Tục Sử Dụng Settings_Delay Này!\n";
echo $daucau2."\033[1;92mNhập \033[1;91m[\033[1;93m2\033[1;91m] \033[1;92mSử Dụng Delay Được Đề Xuất Bởi Tool!\n";
echo $daucau2."\033[1;92mNhập \033[1;91m[\033[1;93m3\033[1;91m] \033[1;92mXoá Delay Này Và Tạo Delay Do Bạn Đặt Ra!\n";
echo "\033[1;32m────────────────────────────────────────────────────────────\n";
echo $daucau2."\033[1;92mNhập số: \033[1;33m";
    $len = strlen($a);
    for ($x = 0; $x < $len; $x++) {
        print $a[$x];
        usleep(800);
...
while (true) {
    while (true) {
        ...
        echo $thanh_dep.$luc."Lưu Ý: ".$hong."Nếu Muốn Dừng Lại Thì Nhấn Enter \n";
            for ($a = 1; $a < 999999; $a++) {
